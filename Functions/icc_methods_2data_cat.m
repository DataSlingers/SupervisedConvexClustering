function [kmeans_ri_X,hclust_ri_X,kmeans_ri_Y,hclust_ri_Y, kmeans_ri_XY,hclust_ri_XY,conca_hclust_ri, agg_hclust_ri] = icc_methods_2data_cat( X,Y,K,truth )
% X: p1 * n
% Y: p2 * n
...
[conca_hclust_ri, agg_hclust_ri ] = hclust_gower_2class_cat( X,Y,K,truth );
